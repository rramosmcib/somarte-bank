...
public class MST601Id implements Serializable {
    ...
    public MST601Id(Integer stemp, Integer stmod, Integer stcta, Integer stoper, 
                    Integer sttope, Integer stsbop, Integer stmda, Integer stnro) {
        this.stemp = stemp;
        this.stmod = stmod;
        this.stcta = stcta;
        this.stoper = stoper;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(stemp, that.stemp) &&
               ...
               Objects.equals(stnro, that.stnro);
    }

    @Override
    public int hashCode() {
        return Objects.hash(stemp, stmod, stcta, stoper, sttope, stsbop, stmda, stnro);
    }
}